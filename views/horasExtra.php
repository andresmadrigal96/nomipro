...
<nav class="navbar navbar-expand-lg navbar-light nv">
  ...
  <h1 class="text-center mt-3">Horas extra</h1>

  <a class="btn btn-primary ml-5 mb-3" href="registrarHoraExtra.php">Registrar hora extra</a>
    ...
    <tbody>
        <?php while($fila = $resultado ->fetch_assoc()){?>
              <tr>
                ...
                <td><a href="editarHoraExtra.php?idHExtra=<?php echo $fila['idHExtra']?>"><img src="https://img.icons8.com/bubbles/50/000000/edit.png"/></a></td>
                <td><a href="../controller/deleteHoraExtra.php?idHExtra=<?php echo $fila['idHExtra']?>"><img src="https://img.icons8.com/office/30/000000/delete-folder.png"/></a></td>
              </tr>
         <?php }?>
        </tbody>
  </table>
