...
<nav class="navbar navbar-expand-lg navbar-light nv">
    ...
    <h1 class="text-center mt-3">Registrar parafiscal</h1>

    <form class="col-7 center p-3 container" action="../controller/insertParafiscal.php" method="post">
        <div class="form-group">
            <label for="nombreP">Nombre*</label>
            <input type="text" class="form-control" id="nombreP" name="nombreP" placeholder="Nombre" required>
        </div>
        <div class="form-group">
            <label for="valor">Valor*</label>
            <input type="text" class="form-control" id="valor" name="valor" placeholder="50000" required>
        </div>
        <div class="form-group">
