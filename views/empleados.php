...
$consulta = "SELECT * FROM empleados inner join cargos on empleados.idCargo_fk=cargos.idCargo inner join vinculaciones on empleados.idVinculacion_fk=vinculaciones.idVinculacion inner join horarios on empleados.idHorario_fk=horarios.idHorario";
...
<nav class="navbar navbar-expand-lg navbar-light nv">
  ...
  <a class="btn btn-primary ml-5 mb-3" href="registrarEmpleado.php">Registrar empleado</a>
    ...
    <tbody>
        <?php while($fila = $resultado ->fetch_assoc()){?>
              <tr>
                ...
                <td><a href="editar.php?idEmpleado=<?php echo $fila['idEmpleado']?>"><img src="https://img.icons8.com/bubbles/50/000000/edit.png"/></a></td>
