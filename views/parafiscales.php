...
<nav class="navbar navbar-expand-lg navbar-light nv">
  ...
  <h1 class="text-center mt-3">Parafiscales</h1>

  <a class="btn btn-primary ml-5 mb-3" href="registrarParafiscales.php">Registrar parafiscal</a>
    ...
    <tbody>
        <?php while($fila = $resultado ->fetch_assoc()){?>
              <tr>
                ...
                <td><a href="editarParafiscal.php?idParafiscal=<?php echo $fila['idParafiscal']?>"><img src="https://img.icons8.com/bubbles/50/000000/edit.png"/></a></td>
                <td><a href="../controller/deleteParafiscal.php?idParafiscal=<?php echo $fila['idParafiscal']?>"><img src="https://img.icons8.com/office/30/000000/delete-folder.png"/></a></td>
              </tr>
         <?php }?>
        </tbody>
  </table>
